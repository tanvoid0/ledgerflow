...
public class TestcontainersConfiguration {
    ...
    PostgreSQLContainer postgres() {
        return new PostgreSQLContainer("postgres:17")
                .withCreateContainerCmdModifier(cmd -> cmd.withName("ledgerflow-test-settlement-postgres-" + suffix))
    ...
    RedpandaContainer redpanda() {
        return new RedpandaContainer("redpandadata/redpanda:v25.2.1")
                .withCreateContainerCmdModifier(cmd -> cmd.withName("ledgerflow-test-settlement-redpanda-" + suffix))
                .withLabel("com.docker.compose.project", "ledgerflow");
    }
}
